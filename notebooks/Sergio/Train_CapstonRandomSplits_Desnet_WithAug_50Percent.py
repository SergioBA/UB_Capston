...
#ReportName
ReportName = "Desnet_WithAug_dataSetRandomSplits_50Percent"
...
base_model = tf.keras.applications.densenet.DenseNet169(                     # Alternative -> resnet_v2.ResNet152V2  /  resnet50.ResNet50
                                          include_top=False,
                                          weights='imagenet',
                                          input_tensor=None,
                                          input_shape=None,
